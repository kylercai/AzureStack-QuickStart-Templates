...
echo 'Uploading templates to the storage account.'

az storage blob upload \
  --container-name $AZS_SA_CONTAINER_NAME \
  --name "$MASTER_DNS_PREFIX/azuredeploy.json" \
  --file "/home/azureuser/acs-engine/_output/$MASTER_DNS_PREFIX/azuredeploy.json"

az storage blob upload \
  --container-name $AZS_SA_CONTAINER_NAME \
  --name "$MASTER_DNS_PREFIX/azuredeploy.parameters.json" \
  --file "/home/azureuser/acs-engine/_output/$MASTER_DNS_PREFIX/azuredeploy.parameters.json"
