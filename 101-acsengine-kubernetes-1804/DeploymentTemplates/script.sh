...
echo "Cloning the ACS-Engine repo/branch: msazurestackworkloads, tempformergehoncao"
git clone https://github.com/msazurestackworkloads/acs-engine -b tempformergehoncao
cd acs-engine
